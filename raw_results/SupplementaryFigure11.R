...
save(teich_scater_QC, file="Benchmarking_paper/processed_files/data/SupplementaryFigure11_scater_object.RData")
...
write.table(QC_Sim, "Benchmarking_paper/processed_files/data/SupplementaryFigure11_reads_alignment_data.txt")
