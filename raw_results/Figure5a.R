...
correct_cells<-read.table("data/correct_cells_no_bulk.txt")
single_cell<-single_cell[,colnames(single_cell) %in% correct_cells$V1]
...
#Filters applied based on plots
filter_ES<-filter<-QC_Sim[QC_Sim$Unique>5000000,]
